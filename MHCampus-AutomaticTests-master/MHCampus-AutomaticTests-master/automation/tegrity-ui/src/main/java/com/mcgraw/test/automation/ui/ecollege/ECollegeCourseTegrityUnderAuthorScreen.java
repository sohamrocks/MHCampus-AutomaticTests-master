...
@PageIdentificator(locators = @DefinedLocators(@DefinedLocator(using = "//div[@class='tablehead' and contains(.,'Tegrity')]")))
public class ECollegeCourseTegrityUnderAuthorScreen extends ECollegeCourseGeneralScreen {
	...
	public ECollegeCourseTegrityUnderAuthorScreen(Browser browser) {
		super(browser);
		// TODO Auto-generated constructor stub
	}

	public ECollegeCourseTegrityUnderAuthorScreen changeCustomerNumber(String customerNumber) {
