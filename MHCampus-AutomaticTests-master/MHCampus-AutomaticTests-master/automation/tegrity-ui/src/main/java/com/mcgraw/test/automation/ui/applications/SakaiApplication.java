...
public class SakaiApplication {
	...
	@Value("${sakai.authentication.service.url}")
	public String sakaiServiceUrl;
	...
	public void completeTegritySetupWithSakai(String courseName,
		...
		browser.waitForElementPresent(browser.findElement(By.xpath(".//span[contains(text(),'Tegrity')]")), 20);
	}
