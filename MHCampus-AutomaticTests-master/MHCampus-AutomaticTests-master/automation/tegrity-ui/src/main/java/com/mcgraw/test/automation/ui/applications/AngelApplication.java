...
public class AngelApplication {
	...
	public void logoutFromAngel() {

		Logger.info("Logout from Angel...");
		browser.switchTo().defaultContent();
		Element logoutButton = browser.waitForElement(By.id("btnLogon"), 30);
		logoutButton.click();
		browser.clickOkInAlertIfPresent();
		browser.waitForPage(AngelLoginScreen.class, 30);
	}
	
	public void completeTegritySetupWithAngel(String sharedSecret, String customerNumber){
