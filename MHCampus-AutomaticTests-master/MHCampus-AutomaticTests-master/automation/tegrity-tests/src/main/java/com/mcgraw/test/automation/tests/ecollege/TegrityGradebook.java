...
//	private String ecollegeCourseId2="8929711";
	...
	public void testSuiteSetup() throws Exception {
		...
		TegrityInstanceConnectorsScreen tegrityInstanceConnectorsScreen = tegrityInstanceApplication.loginToTegrityInstanceAsAdminAndClickManageAairsLink();			
		tegrityInstanceConnectorsScreen.deleteAllConnectors();
		tegrityInstanceConnectorsScreen.configureCustomGradebookConnector(eCollegeApplication.ecollegeTitle, eCollegeApplication.ecollegeGradebookServiceUrl,
	...
	public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(tegrityInstanceApplication.customerNumber, "", ecollegeCourseId1,
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(tegrityInstanceApplication.customerNumber, "", ecollegeCourseId1, assignmentId,
	...
	private void deleteGradebookItems() throws Exception {
		try{
