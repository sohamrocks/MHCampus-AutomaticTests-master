...
public class TegrityDefaultFilter extends BaseTest {
	...
	public void testSuiteSetup() throws Exception {
		...
		tegrityInstanceConnectorsScreen.configureCanvasSsoLinkConnector(canvasApplication.canvasTitle, canvasApplication.canvasFqdn,
	...
	@Test(description = "For Canvas instructor Tegrity link is absent")
	public void checkTegrityLinkIsAbsentInInstructorsCoursesForDefaultFilter() throws Exception {
		...
		Assert.verifyEquals(canvasCourseDetailsScreen.getTegrityLinkCount(), 0, "Wrong count of Tegrity links for instructor's course " + courseName1);
	...
	@Test(description = "For Canvas student Tegrity link is absent")
	public void checkTegrityLinkIsAbsentInStudentsCoursesForDefaultFilter() throws Exception {

		canvasHomeScreen = canvasApplication.loginToCanvasAndAcceptTerms(studentLogin, password);
		canvasCourseDetailsScreen = canvasHomeScreen.goToCreatedCourse(courseName1);
		Assert.verifyEquals(canvasCourseDetailsScreen.getTegrityLinkCount(), 0, "Wrong count of Tegrity links for student's course " + courseName1);
		canvasCourseDetailsScreen = canvasCourseDetailsScreen.goToCreatedCourse(courseName2);
