...
public class TegrityGradebook extends BaseTest {
	...
	public void testSuiteSetup() throws Exception {
		...
		tegrityInstanceConnectorsScreen.configureAngelGradebookConnector(angelApplication.angelTitle,
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(tegrityInstanceApplication.customerNumber, providerId, course1Id,
	...
	private void prepareTestDataInAngel() throws RestEndpointIOException, UnsupportedEncodingException {
		...
		String student2Random = getRandomString(10);
		String course1Random = getRandomString(5);
		String course2Random = getRandomString(5);
