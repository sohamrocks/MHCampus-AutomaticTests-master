...
public class TegrityExcludeAllFilter extends BaseTest {
	...
	public void testSuiteSetup() throws Exception {
		...
		tegrityInstanceConnectorsScreen.deleteAllConnectors();tegrityInstanceConnectorsScreen.configureCanvasAuthorizationConnector(canvasApplication.canvasTitle, canvasApplication.canvasFqdn,
		...
		tegrityInstanceConnectorsScreen.configureCanvasSsoLinkConnectorWithExcludeFilter(canvasApplication.canvasTitle,
