...
public class TegrityGradebook extends BaseTest {
	...
	public void testSuiteSetup() throws Exception {
		...
		tegrityInstanceConnectorsScreen.configureCustomGradebookConnector(d2lApplication.d2lTitle, d2lApplication.d2lGradebookServiceUrl,
				d2lApplication.d2lGradebookExtendedProperties);
	...
	public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(tegrityInstanceApplicationNoLocalConnector.customerNumber, "", courseCode,
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(tegrityInstanceApplicationNoLocalConnector.customerNumber, "", courseCode, assignmentId,
