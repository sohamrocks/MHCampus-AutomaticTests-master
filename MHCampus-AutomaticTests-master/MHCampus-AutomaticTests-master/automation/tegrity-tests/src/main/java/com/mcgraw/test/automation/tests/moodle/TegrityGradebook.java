...
public class TegrityGradebook extends BaseTest {
	...
	private String assignmentId = getRandomNumber(5);
	...
	public void testSuiteSetup() throws Exception {
		...
		tegrityInstanceConnectorsScreen.configureMoodleGradebookConnector(moodleApplication.moodleGradebookExtendedProperties);
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(tegrityInstanceApplication.customerNumber, providerId, courseRS1.getId(),
