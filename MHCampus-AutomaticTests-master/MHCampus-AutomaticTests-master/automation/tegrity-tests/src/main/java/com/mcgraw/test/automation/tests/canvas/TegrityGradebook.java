...
public class TegrityGradebook extends BaseTest {
	...
	public void testSuiteSetup() throws Exception {
		...
		tegrityInstanceConnectorsScreen.configureCanvasGradebookConnector(canvasApplication.canvasTitle, canvasApplication.canvasFqdn,
	...
	@Test(description = "Check TestScore form is submitted successfully for student1", dependsOnMethods = { "checkSubmittingTestScorableItemFormIsSuccessfull" })
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {

		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(tegrityInstanceApplication.customerNumber, providerId,
	...
	@Test(description = "Check TestScore form is submitted successfully for student2", dependsOnMethods = { "checkSubmittingTestScorableItemFormIsSuccessfull" })
