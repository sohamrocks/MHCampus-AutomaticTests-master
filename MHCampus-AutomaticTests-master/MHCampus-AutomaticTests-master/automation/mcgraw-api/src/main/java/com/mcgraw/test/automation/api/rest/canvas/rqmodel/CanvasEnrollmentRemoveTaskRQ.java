...
/**
 * Json representation model for Canvas delete enrollment Uses Jackson (2.x) for
 * data-binding
 * 
...
public class CanvasEnrollmentRemoveTaskRQ {

	@JsonSerialize(using = EnrollmentRemoveTaskSerializer.class)
	@JsonDeserialize(using = EnrollmentRemoveTaskDeserializer.class)
	...
	public static class EnrollmentRemoveTaskSerializer extends JsonSerializer<CanvasRemoveState> {
	...
	public static class EnrollmentRemoveTaskDeserializer extends JsonDeserializer<CanvasRemoveState> {
