...
public class D2lConnectCourseDetailsScreen extends Screen {
	...
	public D2lConnectCourseDetailsScreen(Browser browser) {
		super(browser);
	}
	...
	//added by AleksandrY
	public String addAssignmentChouseModule(Boolean startDateInFurther, String assignmentName, String moduleName, String start, String end, String hourMin) {
		Logger.info("Add assignment to course...");
		String rightAnswer = null;
		createAssignment(assignmentName);
		chooseQuestion();
		...
		addQuestion();
		chooseStartAndEndDates(startDateInFurther, start, end, hourMin);
		Element moduleOption = browser.waitForElement(By.xpath(".//select/option[contains(text(),'" + moduleName + "')]"), 30);
		moduleOption.click();
		browser.pause(500);
		assign.click();
		browser.pause(6000);
	...
	public int getCountOfDeployedAssignments() {
		...
		return browser.getElementsCount(By.cssSelector("div[class='d2l_shp_deploy_icon']"));
	}	
