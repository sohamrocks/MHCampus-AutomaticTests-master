...
public class CanvasConnectCreateAccountScreen extends Screen {
	...
	public CanvasConnectCreateAccountScreen(Browser browser) {
		super(browser);
	}
	...
	public CanvasConnectScreen createCourceInConnect(String course, String section, BookForConnect book){	
		Logger.info("Create cource in 'Connect' with name: " + course + " under section: " + section);	
		cooseTheBook(book);
		CanvasConnectScreen canvasConnectScreen = createCourse(course, section);
		browser.makeScreenshot();		
	...
	private CanvasConnectScreen createCourse(String course, String section){
		Logger.info("Create cource in 'Connect' with name: " + course + " under section: " + section);	
		...
		createCourse.click();
		return browser.waitForPage(CanvasConnectScreen.class);
	}
