...
public class CanvasGradebookScreen extends Screen {
	...
	public boolean checkScoreGrid() {
		try{
			browser.waitForElement(By.id("grade-summary-content"));
			browser.waitForElement(By.id("grades_summary"));
			browser.waitForElement(By.id("GradeSummarySelectMenuGroup"));
