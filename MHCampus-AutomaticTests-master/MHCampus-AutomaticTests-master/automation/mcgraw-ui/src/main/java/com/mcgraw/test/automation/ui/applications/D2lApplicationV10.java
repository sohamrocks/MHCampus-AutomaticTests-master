...
import com.mcgraw.test.automation.ui.d2l.v10.D2lManageExternalToolsScreenV10;
...
public class D2lApplicationV10 extends D2LApplication {
	...
	protected D2lCreateRemotePluginScreen openD2lCreateRemotePluginScreen() {
		return browser.openScreen(createRemotePluginUrl, D2lCreateRemotePluginScreenV10.class);
	}
	
	//Added By Andrii Vozniuk
	@Override
	public D2lManageExternalToolsScreen openD2LManageExternalToolsPage() {
		return browser.openScreen(d2lManageExternalToolsUrl, D2lManageExternalToolsScreenV10.class);
