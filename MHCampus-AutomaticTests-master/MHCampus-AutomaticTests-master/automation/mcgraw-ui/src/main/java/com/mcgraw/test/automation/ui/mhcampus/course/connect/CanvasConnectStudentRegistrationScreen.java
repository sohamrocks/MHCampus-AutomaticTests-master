...
public class CanvasConnectStudentRegistrationScreen extends Screen {
	...
	public CanvasConnectStudentRegistrationScreen(Browser browser) {
		super(browser);
	}
	...
	public CanvasConnectStudentCompleteRegistrationScreen registerAsStudentToConnect(String studentName, String studentPassword) {
		...
		CanvasConnectStudentCompleteRegistrationScreen canvasConnectStudentCompleteRegistrationScreen = null;
		try{
			canvasConnectStudentCompleteRegistrationScreen = fillForm(studentName, studentPassword);
		}catch(Exception e){
		...
		browser.makeScreenshot();
		return canvasConnectStudentCompleteRegistrationScreen;
	}
	
	private CanvasConnectStudentCompleteRegistrationScreen fillForm(String studentName, String studentPassword) {
...
//		browser.makeScreenshot();
		...
		return	browser.waitForPage(CanvasConnectStudentCompleteRegistrationScreen.class);
	}
