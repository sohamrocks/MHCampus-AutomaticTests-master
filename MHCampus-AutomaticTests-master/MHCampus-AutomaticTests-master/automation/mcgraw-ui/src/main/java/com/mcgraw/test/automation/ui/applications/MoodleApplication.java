...
public class MoodleApplication {
	...
	@Value("${moodle.gradebook.extendedproperties.exist}")
	public String moodleGradebookExtendedPropertiesExist;
	
	@Value("${moodle.gradebook.extendedproperties.new}")
	public String moodleGradebookExtendedPropertiesNew;
	...
	public void completeMhCampusSetupWithMoodle(String customerNumber,
			String sharedSecret) {
	...
	public MoodleHomeScreen loginToMoodle(String username, String password) {
		...
		browser.manage().deleteAllCookies();
		moodleLoginScreen = browser.openScreen(moodleBaseUrl,
				MoodleLoginScreen.class);
