...
public class D2lConnectStudentCompleteRegistrationScreen extends Screen {
	...
	public D2lConnectStudentCompleteRegistrationScreen(Browser browser) {
		super(browser);
	}
	...
	public D2lConnectStudentCourseDetailsScreen goToConnect() {
		...
		Element noButton=browser.waitForElement(By.xpath(".//button[text()='No']"),40);
		noButton.click();	
		browser.switchTo().defaultContent();
		browser.makeScreenshot();
		return	browser.waitForPage(D2lConnectStudentCourseDetailsScreen.class, 20);		
	}
}
