...
public class D2lConnectScreen extends Screen {
	...
	public D2lConnectScreen(Browser browser) {
		super(browser);
	}
	...
	public D2lConnectCourseDetailsScreen goToHomePage() {
		Logger.info("Click 'Go to home page' link");
		goToHome.click();
		D2lConnectCourseDetailsScreen d2lConnectCourseDetailsScreen = browser.waitForPage(D2lConnectCourseDetailsScreen.class);
		browser.makeScreenshot();
		
		return d2lConnectCourseDetailsScreen;
	}
}
