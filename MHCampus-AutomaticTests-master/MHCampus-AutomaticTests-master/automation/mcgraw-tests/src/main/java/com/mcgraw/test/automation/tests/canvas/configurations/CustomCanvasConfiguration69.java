...
* Async:  Off
*/
public class CustomCanvasConfiguration69 extends BaseTest {
	@Autowired
	...
	private String courseRandomSIS1 = getRandomString();
	private String courseRandomSIS2 = getRandomString();
	...
	private String courseWithSisName = "CourseName" + courseRandomSIS1;
	private String courseSisId = getRandomString();
	
	private String courseWithSisName2 = "CourseName" + courseRandomSIS2;
	...
	private String customerNumber = "18NN-URG7-SB4W";
	private String sharedSecret = "995104";
	...
	public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber,
				providerId,courseSisId, assignmentId, assignmentTitle, category, description,
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				courseSisId, assignmentId, Integer.toString(student1.getId()), commentForStudent,
	...
	private void prepareTestDataInCanvas() throws Exception {
		...
		course1 = canvasApiUtils.createPublishedCourseWithSis(courseWithSisName, courseSisId);
		course2 = canvasApiUtils.createPublishedCourseWithSis(courseWithSisName2, courseSisId2);
