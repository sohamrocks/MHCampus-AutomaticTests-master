...
public class CustomCanvasConfiguration67 extends BaseTest {
	...
	private String customerNumber = "27X8-Q489-3LWN";
	private String sharedSecret = "CCBF54";
	...
	private String deepAppName = "AConnectDIAleksY";
	...
	@Test(description = "Check TestScorableItem form is submitted successfully Updated Classic", dependsOnMethods = {"checkSubmittingTestScorableItemFormIsSuccessfullClassic"})
	public void checkSubmittingTestScorableItemFormIsSuccessfullUpdatedClassic() throws Exception {
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, providerId,
				course1.getSisCourseId(), updatedAssignmentId, assignmentTitle, category, description, startDate, dueToDate, scoreType,
				scorePossible, isStudentViewable, isIncludedInGrade, canvasApplication.tegrityServiceLocation);
	...
	@Test(description = "Check TestScore form is submitted successfully Classic", dependsOnMethods = { "checkSubmittingTestScorableItemFormIsSuccessfullUpdatedClassic" })
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentClassic() throws Exception {
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				course1.getSisCourseId(), updatedAssignmentId, student1.getLoginId(), commentForStudent1, dateSubmitted,
	...
	private void prepareTestDataInCanvas() throws Exception {
		...
		encryptedStudent2Id = restApp.fillUnencryptedIdAndPressEncrypt(Integer.toString(student2.getId())).getResult();
