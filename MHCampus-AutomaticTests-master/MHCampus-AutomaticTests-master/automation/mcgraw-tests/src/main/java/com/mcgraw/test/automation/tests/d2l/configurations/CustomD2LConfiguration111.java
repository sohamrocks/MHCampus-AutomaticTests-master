...
public class CustomD2LConfiguration111 extends BaseTest {
	...
	private String customerNumber = "2BSP-0BWE-7OOL";
	private String sharedSecret = "31529C";
	private String institution = "CustomCanvasConfiguration111";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("* Instructor Level Token: On | Use Existing Assignments: On | Fallback to user_id and context_id: Off | Legacy: On | Async: Off");
