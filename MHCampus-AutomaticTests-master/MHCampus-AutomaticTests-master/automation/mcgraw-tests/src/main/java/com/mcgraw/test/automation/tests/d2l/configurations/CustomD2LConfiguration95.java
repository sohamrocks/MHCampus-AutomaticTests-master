 ...
 * Async: Off
 */
public class CustomD2LConfiguration95 extends BaseTest {
	...
	private String customerNumber = "1LCE-VEVL-GDJE";
	private String sharedSecret = "515624";
	private String institution = "CustomCanvasConfiguration95";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("* Instructor Level Token: Off | Use Existing Assignments: Off | Fallback to user_id and context_id: On | Legacy: Off | Async: Off");
...
//		Assert.verifyTrue(d2lCourseDetailsScreen.isExistsPlugInErrorMessage(), "plugin is not shown as expected");//Deep
	...
	//============= S C O R A B L E ============
	@Test(description = " ", dependsOnMethods = "checkMHCampusLinkBehavesCorrectlyForD2LStudent2")
	  public void testScorable() throws Exception {
	  ...
	  @Test(description = " ", dependsOnMethods = "testScorable")
	  ...
	  @Test(description = "Check Gradebook data related to the Instructor2", 
			   dependsOnMethods = "testScore")
			 public void checkGradebookItemsAreCorrectForInstructorInCourse2() throws Exception {
