...
public class CustomD2LConfiguration104 extends BaseTest{
	@Autowired
	...
	private String customerNumber = "LCJJ-UDHT-TFWF";
	private String sharedSecret = "F11A2E";
	
	private String courseId1;
	
	private String pageAddressFromEmail = "http://CustomCanvasConfiguration104.mhcampus.com";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("* Instructor Level Token: Off | Use Existing Assignments: On | Fallback to user_id and context_id: Off | Legacy: Off | Async: Off");
		...
		public void checkSubmittingTestScorableItemFormIsSuccessfullExist() throws Exception {
			...
			TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, "", Integer.toString(courseOfferingRS1.getId()) ,
					assignmentIdNew, assignmentTitle, category, "", startDate, dueToDate, scoreType, scorePossible, isStudentViewable,
		...
		public void checkSubmittingTestScoreFormIsSuccessfullForStudentExist() throws Exception {
			...
			TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, "", Integer.toString(courseOfferingRS1.getId()), assignmentIdNew,
					Integer.toString(studentRS1.getUserId()) , commentForStudent1, dateSubmitted, scoreReceivedForStudent1, gradebookApplication.tegrityServiceLocation);
