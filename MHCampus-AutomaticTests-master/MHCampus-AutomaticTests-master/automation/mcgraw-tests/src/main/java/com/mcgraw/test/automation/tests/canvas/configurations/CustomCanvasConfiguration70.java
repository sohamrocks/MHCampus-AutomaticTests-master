...
* Async: Off
*/
public class CustomCanvasConfiguration70 extends BaseTest{
	...
	private String customerNumber = "2Q4T-0209-5NE7";
	private String sharedSecret = "12BD39";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: CustomCanvasConfiguration70");
		Logger.info("LMS = Canvas | DI: Enabled ");
		Logger.info("Course ID – User ID Mapping: SIS – SIS | Gradebook Connector: No | SSO Connector: Yes  | Canvas Mapping: Yes ");
	...
	@Test(description = "Test scorableitem form success submit", dependsOnMethods="testScorableItemSuccessSubmit")
