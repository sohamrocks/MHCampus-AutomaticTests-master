...
* Async: Off
*/
public class CustomCanvasConfiguration33 extends BaseTest {
	...
	private String customerNumber = "1X65-ZYOY-JMIL";
	private String sharedSecret = "DA2AD8";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration:33");
		Logger.info("LMS = Canvas | DI: Enabled ");
		Logger.info("Course ID – User ID Mapping:  Internal – SIS  | Gradebook Connector: Yes | SSO Connector: Yes | Canvas Mapping: Yes ");
		...
		//classic
		 ...
		 canvasCourseDetailsScreen.createMhCampusApplication(appName,customerNumber, sharedSecret,canvasApplication.ltiLaunchUrl);
