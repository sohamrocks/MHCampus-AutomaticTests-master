...
public class CustomCanvasConfiguration40 extends BaseTest {
	...
	// other data
	//private String institutionName = "CustomCanvasConfiguration40";
	private String customerKey = "27V2-A2G6-IV0R";
	private String customerNumber = customerKey;
	private String sharedSecret = "F6205D";
	...
	public void testSuiteSetup() throws Exception {	
		...
		Logger.info("* Instructor Level Token: On | Use Existing Assignments: On | Fallback to user_id and context_id: Off | Async: Off ");
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentExist() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				course1.getSisCourseId(), assignmentIdExist, Integer.toString(student1.getId()), commentForStudent1, dateSubmitted,
