...
* Async:  Off
*/
public class CustomCanvasConfiguration3 extends BaseTest  {
	...
	private String courseName = "CourseName2" + courseRandom;
	...
	private String customerNumber = "2EST-DW9U-T3J4";
	private String sharedSecret = "DCF8BF";
