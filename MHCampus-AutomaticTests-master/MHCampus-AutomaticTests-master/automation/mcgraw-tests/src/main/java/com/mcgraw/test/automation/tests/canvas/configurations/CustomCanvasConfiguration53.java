...
* Async: Off
*/
public class CustomCanvasConfiguration53 extends BaseTest{
	...
	private String customerNumber = "2254-C9T6-RHPR";
	private String sharedSecret = "DD4646";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping:  login -  internal  | Gradebook Connector: Yes | SSO Connector: No | Canvas Mapping: Yes ");
		...
		testRestApi = restApplication.fillUnencryptedIdAndPressEncrypt(String.valueOf(student2.getId()));
