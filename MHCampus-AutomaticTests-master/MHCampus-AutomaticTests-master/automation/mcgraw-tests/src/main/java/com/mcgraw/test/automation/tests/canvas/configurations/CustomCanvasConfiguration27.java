...
* Async: Off
*/
public class CustomCanvasConfiguration27 extends BaseTest {
	...
	private String customerKey = "351T-B6XI-5YWL";
	private String customerNumber = customerKey;
	private String sharedSecret = "B31748";
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentExist() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				course1.getSisCourseId(), assignmentIdExist, studentSis1, commentForStudent1, dateSubmitted,
