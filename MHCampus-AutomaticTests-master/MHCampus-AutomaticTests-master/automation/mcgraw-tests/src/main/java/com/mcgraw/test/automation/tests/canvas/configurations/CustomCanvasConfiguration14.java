...
* Async: Off
*/
public class CustomCanvasConfiguration14 extends BaseTest {
	...
	// private String InstitutionName = "CustomCanvasConfiguration14";
	private String customerNumber = "3KLC-420J-A6D1";
	private String sharedSecret = "E236F2";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info(
				"Course ID – User ID Mapping: Internal - Internal | Gradebook Connector: Yes | SSO Connector: Yes | Canvas Mapping: Yes ");
		Logger.info(
				"* Instructor Level Token: Off | Use Existing Assignments: On | Fallback to user_id and context_id: On | Async: Off");
	...
	public void checkSubmittingTestScoreForExist() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				Integer.toString(course.getId()), assignmentIdForExist, Integer.toString(student.getId()),
