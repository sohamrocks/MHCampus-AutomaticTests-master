...
* Async: Off
*/
public class CustomCanvasConfiguration78 extends BaseTest {
...
//	private String courseSis1 = getRandomString();
	...
	private String customerKey = "38T3-W73V-C0RL";
	private String customerNumber = customerKey;
	private String sharedSecret = "B24E05";
	...
	public void testSuiteSetup() throws Exception {	
		...
		Logger.info("Starting test for configuration:78");
