 ...
 * Async: Off
 */
public class CustomD2LConfiguration110 extends BaseTest {
	...
	private String customerNumber = "3NIG-UACR-REGF";
	private String sharedSecret = "E77C22";
	private String institution = "CustomCanvasConfiguration110";
	...
	//================== Deep Integration ====================
//	      
	@Test(description = "SSO for instructor" , dependsOnMethods = "checkGradebookItemsAreCorrectForInstructorInCourse1")
	...
	@Test(description = "SSO for student", 
	...
	@Test(description = "Check TestScore form is submitted successfully", dependsOnMethods = "testScorableItemDeep")
		public void testScoreDeep() throws Exception {
	...
	@Test(description = "Check Gradebook data related to the Instructor2", 
			dependsOnMethods = "testScoreDeep")
