...
* Gradebook Connector type : none + lti
* SSO Connector: No
* Data Connector: No
* Canvas Mapping: No
...
public class CustomD2LConfiguration124 extends BaseTest{
	@Autowired
	...
	private String customerNumber = "3Q0M-AMFQ-MUVT";
	private String sharedSecret = "B628CA";
	
	private String courseId1;
	
	private String pageAddressFromEmail = "http://CustomCanvasConfiguration124.mhcampus.com";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping: None | Gradebook Connector: Yes | Gradebook Connector type : none+lti | SSO Connector: No | Data Connector:  No| Canvas Mapping: No ");
