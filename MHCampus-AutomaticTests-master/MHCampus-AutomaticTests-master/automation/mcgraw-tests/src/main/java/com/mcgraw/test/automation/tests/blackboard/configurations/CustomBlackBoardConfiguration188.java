 ...
 * Async:  Off
 */
public class CustomBlackBoardConfiguration188 extends BaseTest {
	...
	private String customerNumber = "2MSZ-2AF3-9A7Y";
	private String sharedSecret = "EE907E";
	// private String institution = "CustomBlackboardConfiguration182";
	// private String pageAddressForLogin =
	// "CustomBlackboardConfiguration182.mhcampus.com";
	// private String adminUsername =
	// "admin@CustomBlackboardConfiguration182.mhcampus.com";
	...
	public void checkMHCampusLinkIsPresentInInstructorsCourses() throws Exception {
		...
		Assert.verifyEquals(blackboardCourseDetails.getMhCampusLinksCount(), 0, "Wrong count of MH Campus links for instructor's course " + courseName);
	...
	public void checkMHCampusLinkIsPresenttInStudentsCourses() throws Exception {
		...
		blackboardCourseDetails = blackboardHomeScreen.clickOnCreatedCourse(courseName);
		Assert.verifyEquals(blackboardCourseDetails.getMhCampusLinksCount(), 0, "Wrong count of MH Campus links for student's course " + courseName);
		blackboardCourseDetails.clickMyInstitutionLink();
