...
* Async:  On
*/
public class CustomCanvasConfiguration45 extends BaseTest {
	@Autowired
	...
	private String customerNumber = "6I6N-6I4H-210F";
	private String sharedSecret = "F8A91E";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration:45");
		Logger.info("LMS = Canvas | DI: Enabled ");
		Logger.info(
				"Course ID – User ID Mapping:  Login - Internal  | Gradebook Connector: Yes | SSO Connector: No | Canvas Mapping: No ");
		Logger.info(
		...
		canvasCourseDetailsScreen.createMhCampusApplication(appName, customerNumber, sharedSecret,
				canvasApplication.ltiLaunchUrl , canvasMappingType.LOGINTOINTERNAL , true);
		...
		testRestApi = restApplication.fillUnencryptedIdAndPressEncrypt(Integer.toString(studentWithSis2.getId()));
	...
	private void prepareTestDataInCanvas() throws Exception {
		...
		studentWithSis = canvasApiUtils.createUser(studentWithSisLogin, password, studentWithSisName);
		instructorWithSis = canvasApiUtils.createUser(instructorWithSisLogin, password, instructorWithSisName);
		...
		studentWithSis2 = canvasApiUtils.createUser(studentWithSisLogin2, password, studentWithSisName2);
		instructorWithSis2 = canvasApiUtils.createUser(instructorWithSisLogin2, password, instructorWithSisName2);
