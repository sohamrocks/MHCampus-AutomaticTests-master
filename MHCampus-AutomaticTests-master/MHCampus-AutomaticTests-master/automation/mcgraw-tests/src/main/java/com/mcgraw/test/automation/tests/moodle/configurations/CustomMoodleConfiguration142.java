 ...
 * Asvnc: Off
 */
public class CustomMoodleConfiguration142 extends BaseTest {
	...
	private String customerNumber = "SOZ8-VHB2-608U";
	private String institution = "CustomMoodleConfiguration142";
	private String sharedSecret = "AABCE4";
	private String instUsername = "admin@CustomMoodleConfiguration142.mhcampus.com";
	private String instPassword = "hdffehjr";
	

	@BeforeClass
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: CustomMoodleConfiguration142");
