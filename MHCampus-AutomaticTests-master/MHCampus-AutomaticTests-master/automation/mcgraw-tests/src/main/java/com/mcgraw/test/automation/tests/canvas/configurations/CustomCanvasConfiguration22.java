...
public class CustomCanvasConfiguration22 extends BaseTest {
	...
	private String customerNumber = "S5DB-VSNX-3T73";
	private String sharedSecret = "121EAE";
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentClassic() throws Exception {
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				Integer.toString(course1.getId()), assignmentId, student1.getLoginId(), commentForStudent1, dateSubmitted,
	...
	@Test(description = "Check TestScorableItem form is submitted successfully Deep integration", dependsOnMethods = {"checkSsoAsStudentDeep"})
	...
	@Test(description = "Check TestScore form is submitted successfully Deep integration", dependsOnMethods = { "checkSubmittingTestScorableItemFormIsSuccessfullDeep" })
