...
* Gradebook Connector type : exist 
* SSO Connector:No
* Data Connector: Yes
* Canvas Mapping: No
...
public class CustomD2LConfiguration120 extends BaseTest {	
		...
		private String institution = "CustomCanvasConfiguration120";	
		private String customerKey = "1CDD-5DRM-WQRW";		
		private String sharedSecret = "D287E0";
		...
		public void testSuiteSetup() throws Exception {
			...
			Logger.info("LMS =  D2L ");
			Logger.info("Course ID – User ID Mapping: None | Gradebook Connector: Yes | Gradebook Connector type : exist | SSO Connector:  No | Data Connector: Yes | Canvas Mapping: No");
...
//			}
		...
		public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
			...
			TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerKey, providerId, Integer.toString(courseOfferingRS1.getId()),
		...
		@Test(description = "Check TestScorableItemExist form is submitted successfully" , dependsOnMethods = "checkSubmittingTestScorableItemFormIsSuccessfull")
