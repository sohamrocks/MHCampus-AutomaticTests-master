 ...
 * LMS = Canvas
 * DI: Enabled
 * Course ID â€“ User ID Mapping:  internal - sis
 ...
 */
public class CustomCanvasConfiguration73 extends BaseTest {
	...
	private String customerNumber = "2Y18-BMQU-HODX";
	private String sharedSecret = "CB1C86";
