...
public class CustomCanvasConfiguration89 extends BaseTest {
	@Autowired
	...
	private String customerNumber = "GB7D-T8WL-9KSL";
	private String sharedSecret = "70965C";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("* Instructor Level Token: Off | Use Existing Assignments: Off | Fallback to user_id and context_id: No | Async: Off");
