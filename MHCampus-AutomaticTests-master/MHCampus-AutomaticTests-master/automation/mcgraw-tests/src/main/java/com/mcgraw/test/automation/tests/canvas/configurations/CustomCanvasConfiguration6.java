...
* Async: Off
*/
public class CustomCanvasConfiguration6 extends BaseTest{
	...
	private String customerNumber = "32MT-6CSC-ZFU7";
	private String sharedSecret = "031895";
