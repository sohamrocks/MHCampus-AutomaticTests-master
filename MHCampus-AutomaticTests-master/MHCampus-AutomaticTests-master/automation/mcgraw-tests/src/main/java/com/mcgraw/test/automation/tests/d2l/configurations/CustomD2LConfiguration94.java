 ...
 * Async:  Off
 */
public class CustomD2LConfiguration94 extends BaseTest {
	@Autowired
	...
	private String customerNumber = "76D3-K14E-842B";
	private String sharedSecret = "160D14";
	private String courseId1;

	private String pageAddressFromEmail = "http://CustomCanvasConfiguration94.mhcampus.com";
	...
	// deep
	// -----------------------------------------------------------------------------------------------------------
	@Test(description = "Check MH Campus link is present for D2L instructor in Deep",dependsOnMethods = {
