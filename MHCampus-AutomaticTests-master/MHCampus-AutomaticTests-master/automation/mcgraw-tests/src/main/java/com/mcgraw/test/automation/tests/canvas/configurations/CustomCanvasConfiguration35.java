...
* Async: Off
*/
public class CustomCanvasConfiguration35 extends BaseTest {
	...
	//private String InstitutionName = "CustomCanvasConfiguration35";
	private String CustomerKey = "55OX-UJQ7-9H9A";
	private String sharedSecret = "5286EB";
	...
	private void setupInCanvasClassic() throws Exception{
		...
		canvasCourseDetailsScreen.createMhCampusApplication(appName, CustomerKey, sharedSecret, canvasApplication.ltiLaunchUrl, canvasMappingType.INTERNALTOINTERNAL, false);
		canvasApplication.logoutFromCanvas();
