...
* Async:  Off
*/
public class CustomCanvasConfiguration169 extends BaseTest {
	@Autowired
	...
	private String studentPrefix = "Student3";
	private String instructorPrefix = "Instructor3";
	
	private String studentLogin3;
	private String instructorLogin3;
	private String courseName3;
	private String studentId3;
	private String instructorId3;
	...
	private String commentForStudent3 = "comment3_" + getRandomString();
	private String dateSubmitted = GradebookApplication.getRandomDateSubmitted();
	private String scoreReceivedForStudent = GradebookApplication.getRandomScore();
	private String scoreReceivedForStudent3 = GradebookApplication.getRandomScore();
	...
	private String customerNumber = "2C6T-WQOY-44XH";
	private String sharedSecret = "4F6B0E";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("LMS = Canvas / Blackboard | DI: Enabled ");
		...
		//classic
		 canvasHomeScreen =canvasApplication.loginToCanvas(canvasAdminLogin,canvasAdminPassword);
	...
	@Test(description = "Check blackboard TestScorableItem form is submitted successfully", dependsOnMethods = { "checkDeppSubmittingTestScoreFormIsSuccessfullForStudent" })
	public void checkBBSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, providerId,
				courseName3, assignmentId, assignmentTitle, category, description, startDate, dueToDate, scoreType, scorePossible,
	...
	@Test(description = "Check blackboard TestScore form is submitted successfully", dependsOnMethods = { "checkBBSubmittingTestScorableItemFormIsSuccessfull" })
	public void checkBBSubmittingTestScoreFormIsSuccessfullForStudent() throws Exception {

		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId, courseName3,
				assignmentId, studentLogin3, commentForStudent3, dateSubmitted, scoreReceivedForStudent3,
	...
	private void prepareTestDataInCanvas() throws Exception {
		...
		//Blackboard
		studentLogin3 = studentPrefix + getRandomString();
		instructorLogin3 = instructorPrefix + getRandomString();
		courseName3 = "Course3" + getRandomString();
		...
		studentId3 = blackBoardApi.createUser(studentLogin3, studentLogin3, studentLogin3);
		
		instructorId3 = blackBoardApi.createUser(instructorLogin3, instructorLogin3, instructorLogin3);
		courseId3 = blackBoardApi.createCourse(courseName3);
		
		blackBoardApi.createEnrollment(studentId3, courseId3, BlackboardApiRoleIdentifier.STUDENT);
		blackBoardApi.createEnrollment(instructorId3, courseId3, BlackboardApiRoleIdentifier.INSTRUCTOR);
	...
	private void clearCanvasData() throws Exception {
		...
		if(studentId3 != null)
			blackBoardApi.deleteUser(studentId3);
		if(instructorId3 != null)
			blackBoardApi.deleteUser(instructorId3);
		if(courseId3 != null)
			blackBoardApi.deleteCourse(courseId3);
