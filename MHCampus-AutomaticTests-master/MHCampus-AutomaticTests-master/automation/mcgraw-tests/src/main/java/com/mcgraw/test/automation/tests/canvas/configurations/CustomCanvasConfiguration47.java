...
* Async: On
*/
public class CustomCanvasConfiguration47 extends BaseTest {
	...
	// private String InstitutionName = "CustomCanvasConfiguration47";
	private String customerNumber = "1ZJ0-TMPD-0BYY";
	private String sharedSecret = "355FC8";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info(
				"Course ID – User ID Mapping: Internal – Internal | Gradebook Connector: Yes | SSO Connector: No | Canvas Mapping: No ");
		Logger.info(
