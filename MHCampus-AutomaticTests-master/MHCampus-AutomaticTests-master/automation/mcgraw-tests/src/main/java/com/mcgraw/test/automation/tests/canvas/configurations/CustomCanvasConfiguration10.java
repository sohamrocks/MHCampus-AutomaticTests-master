...
* Async: Off
*/
public class CustomCanvasConfiguration10 extends BaseTest {
	...
	//Preparing users for test (Classic integration)
	...
	private String customerNumber = "2SC6-D40L-GMHL";
	private String sharedSecret = "43A6AA";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping: Internal - Internal | Gradebook Connector: Yes | SSO Connector: No | Canvas Mapping: Yes ");
		...
		canvasCourseDetailsScreen.createMhCampusApplication(appName, customerNumber, sharedSecret,
				canvasApplication.ltiLaunchUrl , canvasMappingType.INTERNALTOINTERNAL , true);
		browser.pause(2000);
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				Integer.toString(course.getId()), assignmentId, Integer.toString(student.getId()), commentForStudent,
	...
	//EXIST CONFIGURATION
	@Test(description = "Check TestScorableItem for Exist Configuration", dependsOnMethods = { "checkSubmittingTestScoreFormIsSuccessfullForStudent" })
	public void checkSubmittingTestScorableItemForExist() throws Exception {

		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber,
				providerId, Integer.toString(course.getId()), assignmentIdForExist, assignmentTitle, category,
	...
	public void checkSubmittingTestScoreForExist() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				Integer.toString(course.getId()), assignmentIdForExist, Integer.toString(student.getId()), commentForStudent,
				dateSubmitted, scoreReceivedForStudent, canvasApplication.tegrityServiceLocation);
	...
	//DEEP INTEGRATION
	@Test(description = "Check SSO to MHC as Instructor with DI configuration", dependsOnMethods = {"checkSubmittingTestScoreForExist" })
	...
	@Test(description = "Check TestScorableItem form is submitted successfully", dependsOnMethods = {"ssoAsStudentDI"})
	public void checkSubmittingTestScorableItemForDI() throws Exception {
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemFormDI(customerNumber, providerId,
				encryptedCourseId, assignmentIdDi, assignmentTitleDi, category, description, startDate, dueToDate, scoreType,
	...
	@Test(description = "Check TestScore form is submitted successfully", dependsOnMethods = { "checkSubmittingTestScorableItemForDI" })
	...
	private void prepareTestDataInCanvas() throws Exception {
		//Classic Integration users & course
