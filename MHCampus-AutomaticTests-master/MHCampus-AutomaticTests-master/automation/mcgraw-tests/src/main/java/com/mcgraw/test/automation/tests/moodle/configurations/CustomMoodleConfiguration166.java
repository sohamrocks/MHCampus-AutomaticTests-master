...
* Async:  Off
*/
public class CustomMoodleConfiguration166 extends BaseTest {
	...
	private String customerNumber = "31RX-WING-FX39";
    private String institution = "CustomerMoodleConfiguration166";
    private String sharedSecret = "3E5C4C";
    private String instPassword = "smwlgigo";

	private MoodleCourseScreen moodleCourseScreen;
	
  

	@BeforeClass
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: CustomerMoodleConfiguration166");
		Logger.info("LMS = Moodle | DI: Disable ");
		Logger.info(
				"Course ID - User ID Mapping: Off | Gradebook Connector: Yes ");
		Logger.info(
	...
	@Test(description = "Check SSO to  MHC as Moodle student")
