...
* Async: Off
*/
public class CustomD2LConfiguration92 extends BaseTest {	
		...
		private String institution = "CustomCanvasConfiguration92";// 	
		private String customerKey = "2HAY-3VDF-1IEM";		
		private String sharedSecret = "84534F";
...
//			}
		...
		private void prepareTestDataInD2l() throws Exception {
			...
			courseCode1 = courseOfferingRS1.getCode();
					//Integer.toString(courseOfferingRS1.getId());
					//getCode();
			...
			d2lApplication.createD2lLinkConnectedWithInstance(linkName, Integer.toString(courseOfferingRS1.getId()), customerNumber, sharedSecret);
			d2lApplication.addCreatedLinkToD2lModule(Integer.toString(courseOfferingRS1.getId()), linkName, moduleName);			
		}
