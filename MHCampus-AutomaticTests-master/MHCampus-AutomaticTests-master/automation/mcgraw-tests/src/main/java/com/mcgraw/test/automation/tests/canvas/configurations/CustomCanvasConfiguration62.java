...
* Async: Off
*/
public class CustomCanvasConfiguration62 extends BaseTest {
	...
	private String courseSisDi = getRandomString(); 
	...
	private String customerNumber = "1KL3-HFNG-V1VG";
	private String sharedSecret = "5017FB";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping: SIS - Login | Gradebook Connector: Yes | SSO Connector: Yes | Canvas Mapping: Yes ");
	...
	public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber,
				providerId, course.getSisCourseId(), assignmentId, assignmentTitle, category, description,
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				course.getSisCourseId(), assignmentId, student.getLoginId(), commentForStudent, dateSubmitted,
	...
	//DEEP INTEGRATION
	@Test(description = "Check SSO to MHC as Instructor with DI configuration", dependsOnMethods = {"checkSubmittingTestScoreFormIsSuccessfullForStudent" })
	...
	private void prepareTestDataInCanvas() throws Exception {
		...
		courseDi = canvasApiUtils.createPublishedCourseWithSis(courseNameDi, courseSisDi);
