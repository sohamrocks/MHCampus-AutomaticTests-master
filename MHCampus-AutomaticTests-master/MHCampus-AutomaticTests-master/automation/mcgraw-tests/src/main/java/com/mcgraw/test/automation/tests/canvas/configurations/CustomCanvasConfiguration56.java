 ...
 * SSO Connector: NO
 * Canvas Mapping: Yes
 * Instructor Level Token: Enabled
 * Use Existing Assignments: Off
 * Fallback to user_id and context_id: Enabled
 */

public class CustomCanvasConfiguration56 extends BaseTest {
	...
	private String customerNumber = "19YK-5FBD-I7JC";
	private String sharedSecret = "081985";
	...
	@Test(description = "Check SSO to MHC as Instructor with ILT Deep integration")
	public void checkSsoAsInstructorIltDeep() throws Exception {
	...
	@Test(description = "Check SSO to MHC as Student Deep integration", dependsOnMethods = { "checkSsoAsInstructorIltDeep" })
