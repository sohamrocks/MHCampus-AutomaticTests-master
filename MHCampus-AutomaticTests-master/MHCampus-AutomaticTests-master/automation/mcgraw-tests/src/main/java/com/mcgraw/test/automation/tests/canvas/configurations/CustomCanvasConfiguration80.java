...
* Async: Off
*/
public class CustomCanvasConfiguration80 extends BaseTest{
	...
	private String customerNumber = "2ESH-BCB5-G0EC";
	private String sharedSecret = "A98219";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: CustomCanvasConfiguration80");
