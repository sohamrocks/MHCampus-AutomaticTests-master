...
* Async: Off
*/
public class CustomCanvasConfiguration84 extends BaseTest {
	...
	// private String InstitutionName = "CustomCanvasConfiguration84";
	private String customerNumber = "199L-5H7T-7P2T";
	private String sharedSecret = "C1699E";
