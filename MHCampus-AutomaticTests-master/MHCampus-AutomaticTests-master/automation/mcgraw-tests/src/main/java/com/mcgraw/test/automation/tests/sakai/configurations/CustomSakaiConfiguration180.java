...
public class CustomSakaiConfiguration180 extends BaseTest {
    ...
    private final String customerNumber = "22QQ-LS6R-8MFM";
    private final String institution = "CustomSakaiConfiguration180";
    private final String sharedSecret = "4A0135";
    private final String instPassword = "tjxiuoag";
