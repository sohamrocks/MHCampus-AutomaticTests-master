...
public class CustomD2LConfiguration103 extends BaseTest{
	@Autowired
	...
	private String institution = "CustomCanvasConfiguration103";// 	
	private String customerKey = "6XL6-OPW3-73WH";		
	private String sharedSecret = "F92934";
...
//		}
	...
	public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, "", courseName1 ,
