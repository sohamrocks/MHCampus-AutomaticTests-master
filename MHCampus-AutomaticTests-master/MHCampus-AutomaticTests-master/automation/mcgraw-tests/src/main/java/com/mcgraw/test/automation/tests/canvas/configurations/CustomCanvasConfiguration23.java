...
* Async: Off
*/
public class CustomCanvasConfiguration23 extends BaseTest{
	...
	private String customerNumber = "2P1C-V2SK-S8K9";
	private String sharedSecret = "68F90A";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: CustomCanvasConfiguration23");
