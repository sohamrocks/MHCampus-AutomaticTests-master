...
* Async:  Off
*/
public class CustomCanvasConfiguration63 extends BaseTest {
	@Autowired
	...
	private String customerNumber = "1UQK-JHJL-J1MR";
	private String sharedSecret = "6AEA4E";
	...
	public void checkSubmittingTestScorableItemForExist() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber,
				providerId, courseWithSis.getSisCourseId(), assignmentIdForExist, assignmentTitle, category,
