...
* Async: Off
*/
public class CustomD2LConfiguration102 extends BaseTest {	
		...
		private String institution = "CustomCanvasConfiguration102";// 	
		private String customerKey = "12NQ-USVQ-O8HI";		
		private String sharedSecret = "F2283F";
...
//		private String adminPassword = "mprwcxde";
		...
		public void testSuiteSetup() throws Exception {
			...
			Logger.info("Course ID – User ID Mapping: None | Gradebook Connector: Yes | Gradebook Connector type :  lti | SSO Connector: No | Data Connector: Yes | Canvas Mapping: No");
		...
		@Test(description = "For D2L instructor MH Campus link baheves correctly", dependsOnMethods ="checkMHCampusLinkIsPresentInStudentsCourses")
...
//			}
		...
		public void checkSubmittingTestScorableItemFormIsSuccessfull() throws Exception {
			...
			TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, "", courseCode1 ,
		...
		public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {
			...
			TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, "", courseCode1, assignmentId,
		...
		@Test(description = "Check Gradebook data related to the Instructor", 
