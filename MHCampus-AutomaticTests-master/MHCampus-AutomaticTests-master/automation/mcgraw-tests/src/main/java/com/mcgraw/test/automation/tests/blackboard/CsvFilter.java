...
public class CsvFilter extends BaseTest {
	...
	private static String FULL_PATH_FILE = "C:\\Temp\\filter_blackboard.csv";
	...
	public void testSuiteSetup() throws Exception {
		...
		mhCampusInstanceApplication.createCsvFile(FULL_PATH_FILE, courseName1);
		mhCampusInstanceConnectorsScreen.chooseCvsListsFilter(FULL_PATH_FILE);
	...
	@Test(description = "For BlackBoard instructor MH Campus link is only present for CSV courses")
	...
	@Test(description = "For BlackBoard student MH Campus link is only present for CSV courses")
