...
* Async: Off
*/
public class CustomCanvasConfiguration81 extends BaseTest{
	...
	private String customerNumber = "2O9L-O48Q-GDQD";
	private String sharedSecret = "B0D054";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: CustomCanvasConfiguration81");
		Logger.info("LMS = Canvas | DI: Disabled ");
		Logger.info("Course ID – User ID Mapping: Internal – Internal | Gradebook Connector: Yes | SSO Connector: No  | Canvas Mapping: No ");
	...
	public void testScorableItemSuccessSubmit() throws Exception {
		...
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber,
				providerId, String.valueOf(course1.getId()), assignmentId, assignmentTitle, category, description,
	...
	public void testScoreSuccessSubmit() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				String.valueOf(course1.getId()), assignmentId, String.valueOf(student1.getId()), commentForStudent1,
