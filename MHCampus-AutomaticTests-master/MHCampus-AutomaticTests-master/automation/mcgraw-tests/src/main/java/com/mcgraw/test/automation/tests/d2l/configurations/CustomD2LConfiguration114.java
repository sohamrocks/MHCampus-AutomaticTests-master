...
public class CustomD2LConfiguration114 extends BaseTest{
	@Autowired
	...
	private String customerNumber = "27WT-TD5J-WY0E";
	private String sharedSecret = "A20DB7";
	private boolean checkBoxShowActiveCourse = false;
	private String courseId1;
	
	private String username = "admin@CustomCanvasConfiguration114.mhcampus.com";
	private String instancePassword = "dfgeiwwt";
	private String institution = "CustomCanvasConfiguration114";
	private String pageAddressForLogin = "http://CustomCanvasConfiguration114.mhcampus.com";
	private String pageAddressFromEmail = "http://CustomCanvasConfiguration114.mhcampus.com";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("* Instructor Level Token: On | Use Existing Assignments: On | Fallback to user_id and context_id: Off | Legacy: Off | Async: Off");
...
//			}
		...
		public void checkSubmittingTestScorableItemFormIsSuccessfullExist() throws Exception {
			...
			TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, "", Integer.toString(courseOfferingRS1.getId()) ,
					assignmentIdForExist, assignmentTitle, category, "", startDate, dueToDate, scoreType, scorePossible, isStudentViewable,
					isIncludedInGrade, gradebookApplication.tegrityServiceLocation);
		...
		@Test(description = "Check TestScore form is submitted successfully", dependsOnMethods = { "checkSubmittingTestScorableItemFormIsSuccessfullExist" })
		public void checkSubmittingTestScoreFormIsSuccessfullForStudent1Exist() throws Exception {

			TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, "", Integer.toString(courseOfferingRS1.getId()), assignmentIdForExist,
