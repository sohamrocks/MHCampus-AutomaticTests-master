...
* Async: Off
*/
public class CustomCanvasConfiguration87 extends BaseTest {
	...
	// other data
	//private String institutionName = "CustomCanvasConfiguration87";
	private String customerKey = "Z1FO-83LH-WJUY";
	private String customerNumber = customerKey;
	private String sharedSecret = "BCA9A3";
	...
	public void SSOasInstructor() throws Exception {
		...
		mhCampusIntroductionScreen = canvasCourseDetailsScreen.clickMhCampusLinkAndAcceptTolkenForLti(true); // iLt is ON
