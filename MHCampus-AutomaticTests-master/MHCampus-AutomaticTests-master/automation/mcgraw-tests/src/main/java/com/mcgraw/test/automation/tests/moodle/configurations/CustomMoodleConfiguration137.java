 ...
 * Async: Off
 */
public class CustomMoodleConfiguration137 extends BaseTest {
    ...
    private final String customerNumber = "3GP4-FIM9-W8K9";
    private final String institution = "CustomMoodleConfiguration137";
    private final String sharedSecret = "92F016";
    private final String instPassword = "ndpqapcq";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Starting test for configuration: CustomMoodleConfiguration137");
		Logger.info("LMS = Canvas | DI: Disabled ");
		Logger.info("Course ID – User ID Mapping: none | Gradebook Connector: Yes | SSO Connector: Yes  | Canvas Mapping: No ");
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent1() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId, courseRS1.getId(),
				assignmentId, studentLogin, commentForStudent1, dateSubmitted, scoreReceivedForStudent1,
		...
		Assert.assertEquals(moodleGradesScreen.getScoreReceived(), scoreReceivedForStudent1, "ScoreReceived did not match");
	}
