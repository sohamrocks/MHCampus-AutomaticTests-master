 ...
 * Async:  Off
 */
public class CustomBlackBoardConfiguration139 extends BaseTest {
	...
	private String customerNumber = "U4IA-633E-04N9";
	private String sharedSecret = "BBFE20";
	private String institution ="CustomBlackboardConfiguration139";
	private String pageAddressForLogin = "CustomBlackboardConfiguration139.mhcampus.com";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping:  Off  | Gradebook Connector: Yes | SSO Connector: Yes | Canvas Mapping: No ");
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				courseName, assignmentId, studentLogin, commentForStudent, dateSubmitted, scoreReceivedForStudent,
				gradebookApplication.tegrityServiceLocation);
