...
* Async: Off
*/
public class CustomD2LConfiguration128 extends BaseTest {
    ...
    private final String customerNumber = "2PW3-1FRT-THUH";
    private final String institution = "CustomD2LConfiguration128";
    private final String sharedSecret = "1F4335";
