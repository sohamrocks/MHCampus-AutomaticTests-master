...
public class CustomCanvasConfiguration75 extends BaseTest {
	...
	private String customerNumber = "218S-ET84-LJWQ";
	private String sharedSecret = "FBB537";
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentClassic() throws Exception {
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				course1.getSisCourseId(), assignmentId, student1.getLoginId(), commentForStudent1, dateSubmitted,
