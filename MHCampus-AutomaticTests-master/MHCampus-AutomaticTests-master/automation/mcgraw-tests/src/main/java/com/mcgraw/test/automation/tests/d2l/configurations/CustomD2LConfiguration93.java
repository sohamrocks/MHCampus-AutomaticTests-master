...
public class CustomD2LConfiguration93 extends BaseTest {	
		...
		private String institution = "CustomCanvasConfigurationClient93";// 	
		private String customerKey = "3K95-RHBW-XGQL";		
		private String sharedSecret = "5D3FAC";
