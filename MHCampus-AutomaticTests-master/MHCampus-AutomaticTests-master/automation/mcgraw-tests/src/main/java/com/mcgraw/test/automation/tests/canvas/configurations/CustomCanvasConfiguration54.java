...
* Async: Off
*/
public class CustomCanvasConfiguration54 extends BaseTest {
	@Autowired
	...
	private String customerNumber = "2LRJ-NMX4-VOWO";
	private String sharedSecret = "98DA60";
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudent() throws Exception {
		...
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				course.getSisCourseId(), assignmentId, Integer.toString(student.getId()), commentForStudent, dateSubmitted,
