...
public class CustomCanvasConfiguration5 extends BaseTest {
	...
	private String customerNumber = "1ASM-PYQU-4E5C";
	private String sharedSecret = "A30894";
	...
	@Test(description = "Check TestScorableItem form is submitted successfully Classic", dependsOnMethods = {"checkSubmittingTestScorableItemFormIsSuccessfullClassic"})
	public void checkSubmittingTestScorableItemFormIsSuccessfullUpdatedClassic() throws Exception {
		TestScoreItemsScreen testScoreItemsScreen = gradebookApplication.fillTestScorableItemForm(customerNumber, providerId,
				Integer.toString(course1.getId()), updatedAssignmentId, assignmentTitle, category, description, startDate, dueToDate, scoreType,
				scorePossible, isStudentViewable, isIncludedInGrade, canvasApplication.tegrityServiceLocation);
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentClassic() throws Exception {
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreForm(customerNumber, providerId,
				Integer.toString(course1.getId()), updatedAssignmentId, Integer.toString(student1.getId()), commentForStudent1, dateSubmitted,
