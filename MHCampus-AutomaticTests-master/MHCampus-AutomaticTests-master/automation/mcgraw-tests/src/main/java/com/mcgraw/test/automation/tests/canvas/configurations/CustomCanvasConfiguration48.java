...
public class CustomCanvasConfiguration48 extends BaseTest {
	...
	private String customerNumber = "31TI-YU9F-0HAY";
	private String sharedSecret = "B5C918";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping: sis – internal");
		...
		canvasCourseDetailsScreen.createMhCampusApplication(appName, customerNumber, sharedSecret, canvasApplication.ltiLaunchUrl , canvasMappingType.SISTOINTERNAL , false);
	...
	public void checkSubmittingTestScoreFormIsSuccessfullForStudentClassic() throws Exception {
		TestScoreScreen testScoreScreen = gradebookApplication.fillTestScoreFormAsync(customerNumber, providerId,
				course1.getSisCourseId(), assignmentId, Integer.toString(student1.getId()), commentForStudent1, dateSubmitted,
