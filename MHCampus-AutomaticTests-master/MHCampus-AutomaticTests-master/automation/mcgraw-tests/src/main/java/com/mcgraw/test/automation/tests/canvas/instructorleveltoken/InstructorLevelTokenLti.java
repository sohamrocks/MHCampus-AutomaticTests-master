...
public class InstructorLevelTokenLti extends BaseTest {
	...
	public void testSuiteSetup() throws Exception {
		...
		canvasCourseDetailsScreen.createMhCampusApplication(appName, instance.customerNumber, instance.sharedSecret, canvasApplication.ltiLaunchUrl);
	...
	public void checkMHCampusLinkPresentInCoursesForInstructor1() {
		...
		canvasCourseDetailsScreen = canvasHomeScreen.goToCreatedCourse(courseName1);
		Assert.verifyEquals(canvasCourseDetailsScreen.getMhCampusLinkWithTolkenCount(), 1, 
	...
	@Test(description = "For Canvas instructor1 and course1 ASK for Authorize Tolken and accept", 
			dependsOnMethods = { "checkMHCampusLinkPresentInCoursesForInstructor1" })
	...
	@Test(description = "For Canvas instructor1 and course2 DON'T ASK for Authorize Tolken",
			dependsOnMethods = { "checkAuthorizePresentForInstructor1Course1" })
