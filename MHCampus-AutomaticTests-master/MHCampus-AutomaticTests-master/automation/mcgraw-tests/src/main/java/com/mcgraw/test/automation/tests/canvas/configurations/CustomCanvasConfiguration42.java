...
* Async:  On
*/
public class CustomCanvasConfiguration42 extends BaseTest {
	...
	private String customerNumber = "2AA5-IODD-ZJE0";
	private String sharedSecret = "292C02";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration:42");
		Logger.info("LMS = Canvas | DI: Enabled ");
		Logger.info(
				"Course ID – User ID Mapping:  Internal – SIS  | Gradebook Connector: Yes | SSO Connector: No | Canvas Mapping: No ");
		Logger.info(
