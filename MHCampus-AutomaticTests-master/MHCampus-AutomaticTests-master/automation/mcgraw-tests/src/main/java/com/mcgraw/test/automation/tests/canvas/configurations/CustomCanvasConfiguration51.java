...
public class CustomCanvasConfiguration51 extends BaseTest {
	...
	private String customerNumber = "1ID1-O7GS-J2K2";
	private String sharedSecret = "CCDBDE";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping: login -  internal");
