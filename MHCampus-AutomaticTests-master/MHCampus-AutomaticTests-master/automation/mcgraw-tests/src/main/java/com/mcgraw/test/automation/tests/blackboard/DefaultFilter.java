...
public class DefaultFilter extends BaseTest {
	...
	@Test(description = "Check BlackBoard connectors are available")
	public void checkBlackBoardConnectorsAreAvailableAfterCompletingSetup() {

		mhCampusInstanceConnectorsScreen = mhCampusInstanceDashboardScreen.clickManageAairs();
		Assert.verifyTrue(mhCampusInstanceConnectorsScreen.isAuthorizationConnectorsAvailable());
		Assert.verifyTrue(mhCampusInstanceConnectorsScreen.isSsoInterlinksConnectorsAvailable());
	}

	@Test(description = "For BlackBoard instructor MH Campus link is absent", dependsOnMethods = { "checkBlackBoardConnectorsAreAvailableAfterCompletingSetup" })
	...
	@Test(description = "For BlackBoard student MH Campus link is absent", dependsOnMethods = { "checkBlackBoardConnectorsAreAvailableAfterCompletingSetup" })
