...
public class CustomD2LConfiguration91 extends BaseTest {
	...
	private String customerNumber = "1SMY-5MKV-GUQV";
	private String sharedSecret = "0356A2";
	private String institution = "CustomCanvasConfiguration91";
	...
	public void testSuiteSetup() throws Exception {
		Logger.info("Starting test for configuration: 91");
