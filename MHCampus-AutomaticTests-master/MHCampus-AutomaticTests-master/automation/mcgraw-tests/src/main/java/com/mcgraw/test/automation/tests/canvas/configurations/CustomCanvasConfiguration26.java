...
* Async: Off
*/
public class CustomCanvasConfiguration26 extends BaseTest {
	...
	// private String InstitutionName = "CustomCanvasConfiguration26";
	private String customerNumber = "1ND5-PEVW-RTQ4";
	private String sharedSecret = "F8A33B";
