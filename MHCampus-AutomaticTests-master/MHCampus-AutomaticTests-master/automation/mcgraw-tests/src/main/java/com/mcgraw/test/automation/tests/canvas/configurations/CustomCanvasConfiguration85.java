...
* Async: Off
*/
public class CustomCanvasConfiguration85 extends BaseTest {
	...
	private String customerNumber = "PJH1-JJ8F-J5PY";
	private String sharedSecret = "BE8186";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info(
				"Course ID – User ID Mapping: SIS – Internal | Gradebook Connector: Yes | SSO Connector: No | Canvas Mapping: Yes ");
		Logger.info(
		...
		canvasCourseDetailsScreen.createMhCampusApplication(appName, customerNumber, sharedSecret,
				canvasApplication.ltiLaunchUrl , canvasMappingType.SISTOINTERNAL , true);
