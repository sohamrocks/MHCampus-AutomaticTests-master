...
* Async:  Off
*/
public class CustomCanvasConfiguration68 extends BaseTest {
	...
	private String customerNumber = "TAHE-VNIT-IG07";
	private String sharedSecret = "7B9ACE";
	...
	public void testSuiteSetup() throws Exception {
		...
		Logger.info("Course ID – User ID Mapping:  Login-SIS  | Gradebook Connector: Yes | SSO Connector: Yes | Canvas Mapping: Yes ");
